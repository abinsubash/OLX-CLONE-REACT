  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 backdrop-brightness-50">
      <div className="bg-white p-5 w-100 h-screen shadow-lg relative ">
        <button className="absolute top-2 right-2 text-black hover:text-gray-700">
          ✖
        </button>
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center w-full mt-10">
            ...
            <button className="w-full border-1 border-black  py-2 px-3 rounded mb-2 flex  hover:border-green-950 hover:text-green-950">
